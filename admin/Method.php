...
?>
 ...
 if (isset($_GET['delete'])) {
    ...
    try {
        // Attempt to delete the record from method
        $query = "DELETE FROM method WHERE methodCode = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("s", $id); // Assuming methodCode is a string, use "s" for string, "i" for integer
        $stmt->execute();
...
<!---?=$sqlStat?--->
        ...
        <div class="row">    
            ...
            <button type="button" class="btn btn-primary" onclick="location.href='../admin/addMethod.php';">
                Add Method
            </button>
            </div>
        </div>
            ...
            <br>
            <form action="form-submission/pdel_Method.php" method="post">
            ...
            <div class="container">
                ...
                <table id="userTable" class="table table-light table-striped">
                    ...
                    <tr>
                        ...
                        <td><?= $rowData->methodName ?></td>
                        <td>
                        <a href="../admin/editMethod.php?id=<?php echo $rowData->methodCode; ?>" data-toggle="tooltip" title="Edit">
                            <img src="../inc/img/edit.webp" width="8%" height="auto" class="d-inline-block align-top">
                        </a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="#" onclick="confirmDelete('<?php echo $rowData->methodCode; ?>')" data-toggle="tooltip" title="Delete">
        ...
        ?>
            ...
            <script type="text/javascript">
                ...
                function confirmDelete(methodCode) {
                    if (confirm('Are you sure you want to delete this record?')) {
                        window.location.href = 'Method.php?delete=' + methodCode;
                    }
                }
