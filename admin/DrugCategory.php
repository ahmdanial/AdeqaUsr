...
<?php
 ...
 if (isset($_GET['delete'])) {
    ...
    try {
        // Attempt to delete the record from drugcategory
        $query = "DELETE FROM drugcategory WHERE CatCode = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("s", $id); // Assuming CatCode is a string, use "s" for string, "i" for integer
        $stmt->execute();
    ...
    <?php
      $sqlStat = "SELECT * FROM drugcategory";
...
<!---?=$sqlStat?--->
        ...
        <div class="row">    
            ...
            <button type="button" class="btn btn-primary" onclick="location.href='../admin/addDrugCat.php';">
                Add Category
            </button>
            </div>
        </div>
            ...
            <br>
            <form action="form-submission/pdel_assignDrugCat.php" method="post">
            ...
            <div class="container">
                ...
                <table id="userTable" class="table table-light table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="../admin/editDrugCat.php?id=<?php echo $rowData->CatCode; ?>" data-toggle="tooltip" title="Edit">
                            <img src="../inc/img/edit.webp" width="8%" height="auto" class="d-inline-block align-top">
                        </a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="#" onclick="confirmDelete('<?php echo $rowData->CatCode; ?>')" data-toggle="tooltip" title="Delete">
        ...
        ?>
            ...
            <script type="text/javascript">
                ...
                function confirmDelete(CatCode) {
                    if (confirm('Are you sure you want to delete this record?')) {
                        window.location.href = 'DrugCategory.php?delete=' + CatCode;
                    }
                }
